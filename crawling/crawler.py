# 웹 크롤링 (Crawling) : 브라우저 드리아버를 이용하여 실제로 각 페이지를 이동하며 '동적'으로 데이터를 수집하는 방법
...
# pip install beautifulsoup4 selenium (동시에 다운 받기)

# pip install requests

import requests # 요청
from bs4 import BeautifulSoup # 쓰려면 요청을 해야함 ^
